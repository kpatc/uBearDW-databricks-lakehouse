...
# Ecriture en Delta Lake (bronze)
query = parsed_df.writeStream \
    .format("delta") \
    .outputMode("append") \
    .option("checkpointLocation", "/opt/spark-apps/checkpoints/trip_events_bronze") \
    .trigger(processingTime="5 minutes") \
    .start("/opt/spark-apps/delta/bronze/trip_events_bronze")
