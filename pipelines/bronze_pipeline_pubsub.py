...
# Variables d'environnement ou secrets Databricks
GCP_PROJECT_ID = spark.conf.get("gcp.project.id", "your-gcp-project-id")
GCP_SERVICE_ACCOUNT_JSON = spark.conf.get("gcp.service.account.json.path", "/dbfs/secrets/gcp-sa-key.json")
